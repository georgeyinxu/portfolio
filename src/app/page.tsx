        ...
        <div className="grid gap-x-4 md:grid-cols-2">
          ...
          <main id="content" className="pt-24 lg:py-24">
            ...
            >
              ...
              <div>
                <p className="mb-4">
                  Back in 2020, I decided to try my hand at creating custom
                ...
                <p className="mb-4">
                  ...
                  also built well under the hood. In my free time, I&apos;m also
                  commited to building an{' '}
                  <a
                    className="font-medium text-slate-200 transition hover:text-teal-300 focus-visible:text-teal-300"
                  ...
                  that brings home food business owners together in Singapore,
                  reigniting the{' '}
                  <a
                    className="font-medium text-slate-200 transition hover:text-teal-300 focus-visible:text-teal-300"
                    href="https://www.newline.co/courses/build-a-spotify-connected-app"
                ...
                <p>
                  When I’m not at the computer, I’m usually slinging around iron
                  circles 🏋🏻 or reading self help books 📖 to better my
